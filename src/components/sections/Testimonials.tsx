  ...
  return (
    <section className="py-24 sm:py-32 relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 will-change-transform">
        <div className="absolute bottom-0 left-0 w-[400px] sm:w-[600px] h-[400px] sm:h-[600px] bg-persian-blue/5 rounded-full blur-[200px]" />
      </div>
            ...
            >
              ...
              >
                ...
                <div className="absolute top-6 right-6 sm:top-8 sm:right-8 lg:top-10 lg:right-10">
                  <Quote className="w-8 h-8 sm:w-10 sm:h-10 text-persian-blue/20" />
                </div>

                <div className="relative z-10">
                  {/* Quote */}
                  <blockquote className="text-base sm:text-lg lg:text-xl text-white/80 leading-relaxed mb-6 sm:mb-8 italic">
                  ...
                  <div className="flex items-center gap-3 sm:gap-4">
                    {/* Avatar placeholder */}
                    <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-persian-blue/40 to-persian-blue/20 flex items-center justify-center flex-shrink-0">
                ...
                <div className="absolute bottom-0 left-6 right-6 sm:left-8 sm:right-8 h-px bg-gradient-to-r from-transparent via-persian-blue/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              </Card>
            </motion.div>
          ))}
        </div>
